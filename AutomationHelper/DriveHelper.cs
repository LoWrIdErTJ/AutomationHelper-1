...
namespace AutomationHelper
{
    public class DriveHelper
    {
        ...
        public static void MapNetworkDrive(string sDriveLetter, string sNetworkPath, string sUserName, string sPassword)
        {
            int result = 0;
            ...
            {
                result = DisconnectNetworkDrive(sDriveLetter, true);
                Console.WriteLine("Disconnect result: {0}", result);
            }

            result = WNetAddConnection2(ref oNetworkResource, sPassword, sUserName, 0);
            Console.WriteLine("Connect result: {0}", result);
        }
